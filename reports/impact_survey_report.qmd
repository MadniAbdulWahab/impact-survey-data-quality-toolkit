...
subtitle: "Synthetic dataset — no real respondents or operations"
date: "2026-07-10"
format:
  html:
    toc: true
...
This report presents a reproducible monitoring and data-quality workflow.
...
transparent keyword rule assigns one theme to each comment. This supports an
inspectable data-management and reporting workflow, but it is not a substitute
for iterative human coding of real qualitative data.
...
- Duplicate handling keeps the first submission identifier under a documented
  deterministic rule; a live project would confirm the resolution with the
  data owner.
